...
class UI:
    ...
    def print_menu():
        ...
        print("8. Hamiltonian cycle of low cost")
        print("0. Exit")
    ...
    def run(self):
        print("Welcome!")
        print("This program finds a Hamiltonian cycle of low cost (approximate TSP) by using the heuristic of sorting ")
    ...
    def Hamilton(self):
        path, exists = self.__service.hamCycle()
        if exists is False:
