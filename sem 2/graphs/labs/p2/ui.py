...
class UI:
    ...
    def print_menu():
        ...
        print("5. Get outbound edges of a vertex. ")
        print("6. Get inbound edges of a vertex. ")
        print("7. Get cost of edge. ")
        print("8. Modify cost of edge. ")
        ...
        print("13. Copy graph.")
        print("14. Read graph. ")
        print("15. Write graph. ")
        print("16. Generate random graph.")
        print("17. Find the connected components of the graph.")
        print("0. Exit")
    ...
    def run(self):
        ...
        while True:
            ...
            if command == 1:
                ...
                # if anything needs to be done with it>?
                self.copy()
            elif command == 14:
                self.read()
            elif command == 15:
