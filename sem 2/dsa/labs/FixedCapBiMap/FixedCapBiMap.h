...
class FixedCapBiMap {
	...
	//removes a key k with all the values that belong to it. Returns a ValuePair containing the removed values in the following way:
	// - if k had 2 associated values, there are in valuePair
	// - if k had 1 associated value, that value is the first component in the ValuePair, the second component is NULL_TVALUE
